...
@required
/** 
control for checking if view has been dismissed
 */
...
- (void)presentModal:(DMCustomModalViewController *)modalViewController;
...
@property (nonatomic, retain) id<DMCustomViewControllerDelegate> delegate;
/**
