...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        self.fontColorLabelSelected  = APPTERTIARYCOLOR;

        // Default fonts.
        self.fontTitle = FONTREGULAR(18);
        self.fontLabel = FONTREGULAR(16);
        self.fontLabelSelected = FONTBOLD(24);
...
-(id)initWithParentView:(UIView*)parentView {
    ...
    if ([self initWithFrame:CGRectMake(0.0, _parentView.frame.size.height, _parentView.frame.size.width, kFlatDatePickerHeight)]) {
        ...
        tapGesture = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(actionButtonValid)];
...
- (void)actionButtonCancel {
    ...
    [_parentView removeGestureRecognizer:tapGesture];
}
...
-(void)show {
    ...
    [CURRENT_VIEW addGestureRecognizer:tapGesture];
}
...
-(void)dismiss {
    ...
    [CURRENT_VIEW removeGestureRecognizer:tapGesture];
}
