...
#define APPCOLOR [UIColor colorWithRed:247/255.0 green:45/255.0 blue:72/255.0 alpha:1.0]
...
// Font
NSString *kDefaultFont = @"SourceSansPro-Regular";
NSString *kTitleFont = @"SourceSansPro-Semibold";
NSString *kButtonFont = @"SourceSansPro-Regular";
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        _labelTitle.font = [UIFont fontWithName:kTitleFont size:20];
        
        // View text
        _viewText.editable = NO;
        _viewText.allowsEditingTextAttributes = YES;
        _viewText.textAlignment = NSTextAlignmentCenter;
        _viewText.font = [UIFont fontWithName:kDefaultFont size:14];
...
//        }
    ...
    _circleViewBackground.frame = CGRectMake(0, 0, 0, 0);
   // _circleViewBackground.layer.cornerRadius = _circleViewBackground.frame.size.height / 2;
    ...
    _circleIconImageView.frame = CGRectMake(0, 0, 0, 0);
    ...
    _labelTitle.frame = CGRectMake(12.0f, kCircleHeight / 2 + 12.0f - 30, kWindowWidth - 24.0f, 40.0f);
    _viewText.frame = CGRectMake(12.0f, 74.0f - 10, kWindowWidth - 24.0f, kTextHeight + 3);
    
    // Title is nil, we can move the body message to center
    if(_labelTitle.text == nil)
    {
        _viewText.frame = CGRectMake(12.0f, kCircleHeight - 15, kWindowWidth - 24.0f, kTextHeight);
    }
...
- (UITextField *)addTextField:(NSString *)title
{
    ...
    txt.font = [UIFont fontWithName:kDefaultFont size:14];
...
- (SCLButton *)addButton:(NSString *)title
{
    ...
    btn.titleLabel.font = [UIFont fontWithName:kDefaultFont size:14];
