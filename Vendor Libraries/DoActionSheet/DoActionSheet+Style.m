...
//  RedmartNewProducts
//
//  Created by Shekhar on 03/01/2015.
...
@implementation DoActionSheet (Style)
...
- (void)setStyle1
{
    self.doBackColor = WHITECOLOR;
    self.doButtonColor = APPPRIMARYCOLOR;
    self.doCancelColor = APPSECONDARYCOLOR;
    self.doDestructiveColor = [UIColor clearColor];
    
    self.doTitleTextColor = APPPRIMARYCOLOR;
    ...
    self.doTitleFont = FONTREGULAR(15);
    self.doButtonFont = FONTREGULAR(17);
    self.doCancelFont = FONTREGULAR(17);
