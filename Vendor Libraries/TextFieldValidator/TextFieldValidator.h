 ...
 */
#define ColorPopUpBg [UIColor colorWithRed:36/255.0 green:31/255.0 blue:89/255.0 alpha:0.8]
 ...
 */
@protocol TextFieldValidatorDelegate <NSObject>

- (void)showTextFieldAlert:(NSString*)msg;
...
@property (assign, nonatomic) id<TextFieldValidatorDelegate>textfielddelegate;
@property (nonatomic,assign) BOOL isMandatory;   /**< Default is YES*/

@property (nonatomic,assign) int additionalTag;
